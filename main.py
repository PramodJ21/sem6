...
from views.processing_page import ProcessingPage
...
class MainWindow(QStackedWidget):
    def __init__(self):
        ...
        self.processing_page = ProcessingPage(self.switch_to_convert)
        ...
        self.convert_page = ConvertPage(self.switch_to_home,self.switch_to_gallery,self.switch_to_convert, self.switch_to_settings, self.switch_to_profile,self.switch_to_sign_in, self.switch_to_processing_page)
    ...
    def switch_to_processing_page(self):
        ...
        self.processing_page.start_processing()
